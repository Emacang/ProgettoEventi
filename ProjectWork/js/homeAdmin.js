...
function caricaEventi(){
    ...
    .then(data =>{
        ...
        data.forEach(evento => {
            ...
            a.href = `eventoSingoloAdmin.html?eventoID=${evento.eventoID}`
...
function calendario(){
    ...
    .then(data =>{
        ...
        data.forEach(evento => {
            ...
            titoloCal.href = `eventoSingoloAdmin.html?eventoID=${evento.eventoID}`;
            ...
            titoloCal2.href = `eventoSingoloAdmin.html?eventoID=${evento.eventoID}`;
...
function eventiFuturi(){
    ...
    .then(data =>{
        ...
        data.forEach(evento => {
            ...
            btnInfo.href = `eventoSingoloAdmin.html?eventoID=${evento.eventoID}`
            ...
            function formatDataItaliana(dataString) {
                ...
                let dataIta = formatDataItaliana(dataAmericana);
                        ...
                        btnInfo1.href = `eventoSingoloAdmin.html?eventoID=${evento.eventoID}`
