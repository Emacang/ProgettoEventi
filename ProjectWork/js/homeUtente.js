...
function calendario(){
    ...
    .then(data =>{
        ...
        data.forEach(evento => {
            ...
            titoloCal.href = `eventoSingolo.html?eventoID=${evento.eventoID}`;
            ...
            titoloCal2.href = `eventoSingolo.html?eventoID=${evento.eventoID}`;
        ...
        data.forEach(evento => {
            ...
            function formatDataItaliana(dataString) {
                ...
                let dataIta = formatDataItaliana(dataAmericana);
                        ...
                        btnInfo1.href = `eventoSingolo.html?eventoID=${evento.eventoID}`
